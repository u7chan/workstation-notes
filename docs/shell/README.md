...
現在の実配布元は `chezmoi/` 配下の dotfiles を正とし、`examples/bash/` は参照実装として残す。
...
- 実配布用 source: `chezmoi/dot_bashrc`, `chezmoi/dot_bashrc.local`, `chezmoi/dot_bash_aliases`, `chezmoi/dot_bash_functions`
